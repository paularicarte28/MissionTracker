        ...
        <div class="col">
            <div class="card h-100 bg-secondary text-white border-warning shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <strong>Launch Date:</strong> <%= m.getLaunchDate() %><br>
                        <strong>Objective:</strong> <%= m.getObjective() %><br>
                        <strong>Status:</strong> <%= m.getStatus() %>
                    </p>
                    <div class="d-flex justify-content-center gap-2">
                        <a href="<%= request.getContextPath() %>/misiones/detalle?id=<%= m.getId() %>" class="btn btn-outline-info btn-sm">Details</a>
                        <form method="get" action="<%= request.getContextPath() %>/misiones/eliminar"
